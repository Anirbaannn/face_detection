...
# Full Absolute path to the directory containing known faces
KNOWN_FACES_DIR = 'E:/nielet/cv/attandance/known_faces'
# Full Path to the CSV file to log attendance
ATTENDANCE_FILE = 'E:/nielet/cv/attandance/attendance.csv'
